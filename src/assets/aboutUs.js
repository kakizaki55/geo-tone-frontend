export const aboutUs = [
  {
    ...
    bio: 'Forest is a full-stack web developer in Portland, OR. He loves the feeling one gets when the beat drops - and aims to bring that feeling to all he does in life. Let’s rock!',
    photo: 'tetrahedron',
  ...
  },
  {
    ...
    bio: 'Full Stack Software Engineer in Portland, OR. with a background in audio production and a passion for synthesizers, also known as Bleep Bloops',
    photo: 'triangle',
    geoTone: './user/:username',
  },
];
